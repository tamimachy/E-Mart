...
import 'package:e_mart_project/screens/registration_page.dart';
          ...
          Padding(
              ...
              child: Container(
                ...
                child: TextButton.icon(
                    ...
                    icon: Icon(Icons.close, color: Colors.blueGrey[900],),
                    label: Text("Skip", style: GoogleFonts.ebGaramond(textStyle: h5),)
                ),
              )
          )
        ],
        ...
        children: [
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                  prefixIcon: Icon(Icons.lock_rounded, color: Colors.deepPurpleAccent),
                  hintText: "**************",
                  labelText: "Password",
                  labelStyle: GoogleFonts.ebGaramond(textStyle: h4),
